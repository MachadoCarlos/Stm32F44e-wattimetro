...
/* Definitions for aquisao */
osThreadId_t aquisaoHandle;
const osThreadAttr_t aquisao_attributes = {
  .name = "aquisao",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for DmaPronto */
osSemaphoreId_t DmaProntoHandle;
const osSemaphoreAttr_t DmaPronto_attributes = {
  .name = "DmaPronto"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* creation of DmaPronto */
  DmaProntoHandle = osSemaphoreNew(1, 1, &DmaPronto_attributes);
  ...
  /* creation of aquisao */
  aquisaoHandle = osThreadNew(LerADC, NULL, &aquisao_attributes);
...
/* USER CODE BEGIN Header_LerADC */
/**
* @brief Function implementing the aquisao thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_LerADC */
void LerADC(void *argument)
{
